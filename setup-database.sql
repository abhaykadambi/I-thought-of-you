-- Setup script for Settings functionality
...
SELECT 'user_settings table created successfully' as status WHERE EXISTS (
    SELECT FROM information_schema.tables 
    WHERE table_name = 'user_settings'
);

SELECT 'blocked_users table created successfully' as status WHERE EXISTS (
    SELECT FROM information_schema.tables 
